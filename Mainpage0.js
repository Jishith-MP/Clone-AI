...
// Function to redirect the user based on authentication state
// Get a reference to the button element
  const tryNowButton = document.getElementById('trynow');
  ...
  tryNowButton.addEventListener('click', function() {
    ...
    auth.onAuthStateChanged(user => {
      if (user) {
        ...
        window.location.href = 'Authentication.html'; // Replace 'Authentication.html' with your authentication page URL
      }
    });
  });